        ...
        if (this.state.isUpdated) {
            return <div className={this.state.data.state.name + " "}>
                ...
                <div className="card-body text-center">
                    ...
                    <input className="input-group-text bg-secondary text-white" type="text" type="text"
...
class TaskDashboard extends React.Component {
    ...
    render() {
        ...
        return <div className="dashboard">
            ...
            <a className="badge badge-primary" href={this.props.apiUrl + "/create"}><h2>Add task</h2></a>
